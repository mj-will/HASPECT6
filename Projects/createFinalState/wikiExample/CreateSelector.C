...
void CreateSelector(){
	...
	sk->CreateSelector("Histo","/home/dglazier/Dropbox/hsana/Events/HASPECT6/Projects/finalstates/omega/data/hs_4_8_3/out_gemc_32975713.farmpbs14_t-1_s1.root","HSParticles"); //create selector with all specifications
