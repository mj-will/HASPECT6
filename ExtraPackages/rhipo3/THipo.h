...
class THipoBankParser  {
  ...
  int CodeToType(string code);
  TString CodeToItem(string code);
...
class THipoItemB : public THipoItem{
 ...
 public:
 THipoItemB(hipo::node<int8_t>* node,Int_t *entry):THipoItem(entry) {fNodeB=node;fNode=dynamic_cast<hipo::generic_node*>(fNodeB);fNode->type(1);};
  virtual ~THipoItemB(){}
...
class THipoItemS : public THipoItem{
 ...
 public:
 THipoItemS(hipo::node<int16_t>* node,Int_t *entry):THipoItem(entry) {fNodeS=node;fNode=dynamic_cast<hipo::generic_node*>(fNodeS);fNode->type(2);};
 virtual ~THipoItemS(){}
...
class THipoItemI : public THipoItem{
 ...
 public:
 THipoItemI(hipo::node<int32_t>* node,Int_t *entry):THipoItem(entry) {fNodeI=node;fNode=dynamic_cast<hipo::generic_node*>(fNodeI);fNode->type(3);};
 virtual ~THipoItemI(){}
...
class THipoItemF : public THipoItem{
 ...
 public:
 THipoItemF(hipo::node<float_t>* node,Int_t *entry):THipoItem(entry) {fNodeF=node;fNode=dynamic_cast<hipo::generic_node*>(fNodeF);fNode->type(4);};
 virtual ~THipoItemF(){}
...
class THipoItemD : public THipoItem{
 ...
 public:
 THipoItemD(hipo::node<double_t>* node,Int_t *entry):THipoItem(entry) {fNodeD=node;fNode=dynamic_cast<hipo::generic_node*>(fNodeD);fNode->type(5);};
 virtual ~THipoItemD(){}
...
class THipoBank  {
 ...
 THipoBank(TString name):fName(name){};
  ...
  void AddItem(THipoItem* item,TString name){fVecItems.push_back(item); fVecItems.back()->SetName(name);}
 ...
 protected:
  ...
  vector<THipoItem* > fVecReadItems;
  Bool_t fIsVector=kTRUE;
