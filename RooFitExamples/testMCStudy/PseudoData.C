...
//root 'PseudoData.C( "Data.root" ,10000,10,1,kFALSE)'
//root 'PseudoData.C("SimData.root",500000,10,1,kTRUE)'
...
void PseudoData(TString filename,Long64_t Nev=10000,Double_t res=0,Int_t acc=1,Bool_t fIsMC=kFALSE){
  IsAcc=acc;
  PhiRes=res;
  gRandom->SetSeed(303);
